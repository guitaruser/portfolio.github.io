const COMMANDS = {
    ...
    skills:
      '<span class="code">Languages:</span> Python, Java, C, SQL, Javascript<br><span class="code">Technical:</span> Network Pentesting, Kali Linux, Software Testing, Bash Scripting, Web Development, Android App development, Artifical Intelligence and Machine learning<br><span class="code">Tools:</span> Metasploit Framework, Nmap, Burpsuite,Maltego, MSFVenom, Wireshark.',
    edu:
      "National Public School Rnr, 2008-2021<br> Self Learning since 2017",
    contact:
      "You can contact me on any of following links:<br><a href='https://www.instagram.com/guitaruser19/' class='success link'>Instagram</a> , <a href='https://twitter.com/load_thecode' class='success link'>Twitter</a>",
    ltc:
      "Startup Aiming to change the way india sees education. We believe that knowledge should never come with a price tag.<br>You can find more details here:<br><a href='https://www.instagram.com/load_thecode/' class='success link'>Instagram Page</a><br><a href='https://t.me/loadthecode' class='success link'>Free Resource Sharing Group</a><br><a href='https://www.loadthecode.ml' class='success link'>Official Website</a><br>"
    };
